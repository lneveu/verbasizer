<template>
  ...
  >
    <textarea
      ...
      :disabled="!active"
      :class="[
        'bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 md:w-64 leading-normal resize-none',
        !active ? 'opacity-50' : '',
      ]"
    ></textarea>
    <div class="flex justify-end" v-if="hovered && showCmds">
      <button
